...
/**
 * Implementeres av komponenter skal overvÃ¥kes av selftest
 */
public interface Pingable {

    /**
     * Denne metoden mÃ¥ implementeres, og brukes til Ã¥ sjekke et om en avhengighet er oppe. Det er viktig
     * at man fanger opp eventuelle exceptions i koden, da uhÃ¥ndterte exceptions vil fÃ¸re til at selftest-siden
    ...
    final class Ping implements Serializable {
        ...
        public static class PingMetadata {
             ...
             * @param beskrivelse En kort beskrivelse av hva selftesten gjÃ¸r. Denne beskrivelsen bÃ¸r vÃ¦re god nok til at
             *                    den kan forstÃ¥s av folk uten detaljkunnskaper om applikasjonen.
             * @param kritisk Hvor vidt dette er en kritisk feil eller ikke. En ukritisk feil betyr at applikasjonen
             *                fint kan kjÃ¸re selv om tjenesten er nede. Har en selftest ingen kritiske feil vil den
