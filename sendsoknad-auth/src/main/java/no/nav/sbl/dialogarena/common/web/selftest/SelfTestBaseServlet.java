...
public abstract class SelfTestBaseServlet extends HttpServlet {
    ...
    /**
     * Denne metoden mÃ¥ implementeres til Ã¥ returnere applikasjonens navn, for bruk i tittel og overskrift
     * pÃ¥ selftestsiden.
    ...
    /**
     * Denne metoden mÃ¥ implementeres til Ã¥ returnere en Collection av alle tjenester som skal inngÃ¥
     * i selftesten. Tjenestene mÃ¥ implementere Pingable-grensesnittet.
    ...
    protected void doPing() {
        ...
        // SÃ¦rlig viktig hvis det tar lang tid Ã¥ utfÃ¸re alle pingables
        synchronized (this) {
    ...
    protected String getApplicationVersion() {
        return this.getApplicationVersjonFromManifest();
    }
