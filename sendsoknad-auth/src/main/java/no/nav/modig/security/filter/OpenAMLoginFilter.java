...
/**
 * Se <a href=http://confluence.adeo.no/pages/viewpage.action?pageId=54276633>Utviklerh̴ndbok - Sikkerhet - Ekstern Single Sign
 * On</a> for n̴r og hvordan dette filteret skal brukes.
 */
public class OpenAMLoginFilter extends OncePerRequestFilter {
    ...
    protected boolean login(HttpServletRequest request, String requestEksternSsoToken, HttpServletResponse response) throws IOException {
        try {
            ...
            request.login(requestEksternSsoToken, null);
