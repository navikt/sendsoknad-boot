...
public class FillagerService {
    ...
    @Autowired
    public FillagerService(@Qualifier("fillagerEndpoint") FilLagerPortType filLagerEndpoint, @Qualifier("fillagerSelftestEndpoint") FilLagerPortType filLagerSelftestEndpoint) {
		super();
	...
	public void lagreFil(String behandlingsId, String uid, String fnr, InputStream fil) {
        ...
        try {
            ...
            logger.error("Fikk ikke lagret fil til henvendelse for {}", behandlingsId);
