...
public class PersonaliaFletter {
    ...
    @Autowired
    public PersonaliaFletter(PersonService personService,@Qualifier("brukerProfilEndpoint") BrukerprofilPortType brukerProfil, KodeverkInterface kodeverk,
    ...
    private static String finnUtenlandskKontoLand(XMLBruker xmlBruker, KodeverkInterface kodeverk) {
    ...
    private static Adresse finnGjeldendeAdresse(XMLBruker xmlBruker, KodeverkInterface kodeverk) {
        return new AdresseTransform().mapGjeldendeAdresse(xmlBruker, kodeverk);
    }
    
    private static Adresse finnFolkeregistrertAdresse(XMLBruker xmlBruker, KodeverkInterface kodeverk) {
        return new AdresseTransform().mapFolkeregistrertAdresse(xmlBruker, kodeverk);
    }

    private static Adresse finnSekundarAdresse(XMLBruker xmlBruker, KodeverkInterface kodeverk) {
